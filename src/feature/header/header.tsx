...
export function Header() {
  return (
    <>
      <header className="flex items-center justify-between p-4 shadow-lg lg:hidden">
      ...
      <header className="hidden grid-cols-[1fr_125px_1fr] place-items-center bg-white py-4 shadow-lg lg:grid">
